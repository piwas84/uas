/* Lampa.plugin — джерело UA (головна + історія + самооновлення) */
(function () {
    'use strict';
    ...
    wait(function () {
        ...
        // Самооновлення: при поверненні на головну скидаємо кеш раз на 30 хв
        if (Lampa.Listener) {
        ...
        // Періодичне очищення кешу (Lampa довго відкрита)
